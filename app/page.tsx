  ...
  return (
    <main className="min-h-screen bg-[#fff8f2] text-[#201a17]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-7 px-5 py-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-12">
          <div className="rounded-lg bg-[#201a17] p-6 text-white shadow-[0_30px_90px_rgba(48,23,11,0.28)] lg:p-8">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link
                className="inline-flex items-center gap-2 rounded-md border border-white/[0.18] bg-white/[0.08] px-5 py-3 text-sm font-bold text-white"
                href="/admin/workers"
              >
                Ver gestores
              </Link>
          ...
          <div className="rounded-lg border border-[#f1ddcf] bg-white p-5 shadow-[0_28px_80px_rgba(96,47,17,0.14)]">
            <div className="flex flex-col gap-4 border-b border-[#f4e2d6] pb-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <h2 className="mt-1 text-2xl font-bold">
                Colas privadas para cada gestor
              </h2>
              </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <Metric label="Gestores" value="19" />
              <Metric label="Acceso" value="URL unica" />
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-10 lg:px-8">
        <div className="rounded-lg border border-[#f1ddcf] bg-white p-6 shadow-sm">
          <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <h2 className="text-xl font-bold">Acceso publico sin ChatGPT</h2>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-[#7f6b60]">
                Los gestores ingresan con el enlace que les entrega el
                administrador. La portada publica no publica claves ni lista
                usuarios de trabajo.
              </p>
            </div>
            <Link
              className="inline-flex items-center justify-center gap-2 rounded-md bg-[#fd5b00] px-5 py-3 text-sm font-bold text-white shadow-[0_18px_45px_rgba(253,91,0,0.25)]"
              href="/admin"
            >
