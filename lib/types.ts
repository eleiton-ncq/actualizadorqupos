...
export type ClientRecord = {
  ...
  updated_main_contact_name: string | null;
  updated_main_contact_phone: string | null;
  updated_main_contact_email: string | null;
  updated_billing_contact_name: string | null;
  updated_billing_contact_phone: string | null;
  updated_billing_contact_email: string | null;
  updated_support_contact_name: string | null;
  updated_support_contact_phone: string | null;
  updated_support_contact_email: string | null;
  updated_address_province: string | null;
  updated_address_canton: string | null;
  updated_address_district: string | null;
  updated_address_details: string | null;
